...
if (woj$l_abs[[1]] < progLiczebnosci | woj$Z4_ucz[[1]]$n < progLiczebnosci) {
  ...
  tabelka <- tabelka %>% 
    ...
    kable_styling(position = wyrownanieTabWykr,
                  ...
                  full_width = FALSE,
                  repeat_header_text = "(ciąg dalszy tabeli)") %>%
    add_header_above(c(" ", "Absolwenci LO dla dorosłych\nz całego kraju kontynuujący naukę" = 1, "Absolwenci LO dla dorosłych\nz całego kraju niekontynuujący nauki" = 1),
                     align = c("l", "c", "c"))
...
if (woj$l_abs[[1]] >= progLiczebnosci & woj$Z4_ucz[[1]]$n >= progLiczebnosci) {
  ...
  tabelka <- tabelka %>% 
    ...
    kable_styling(position = wyrownanieTabWykr,
                  ...
                  full_width = FALSE,
                  repeat_header_text = "(ciąg dalszy tabeli)") %>%
    add_header_above(c(" ", "Absolwenci LO dla dorosłych\nz województwa kontynuujący naukę" = 1, "Absolwenci LO dla dorosłych\nz województwa niekontynuujący nauki" = 1),
                     align = c("l", "c", "c"))
